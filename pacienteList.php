                                    ...
                                    <tbody>
                                        ...
                                        foreach ($listaPacientes as $paciente) {
                                            ...
                                            "<tr>".
                                                ...
                                                "<td>
                                                    <a href='./controller/pacienteController".$paciente->getId()."' class='btn btn-outline-warning'><i class='fas fa-pen'></i>Editar</a>
                                                    <a href='./controller/pacienteController".$paciente->getId()."' class='btn btn-outline-danger'><i class='fas fa-trash'></i>Apagar</a>
                                                </td>".
                                            "</tr>";
                                        }
                                        ?>
